...
class BlogAuthor(models.Model):
    ...
    profile_image = ProcessedImageField(verbose_name=_("Profile Image"), null=True, blank=True, upload_to="profile_images/", format="JPEG", options={"quality": 90}, processors=[ResizeToFill(width=500, height=1000)], help_text=_("Select a profile image for your account (optional)"))
    ...
    ### Social Media Links
    instagram_link = models.URLField(verbose_name=_("Instagram Link"), help_text=_("Add the link to your Instagram page here (optional)."), blank=True, null=True, max_length=300)
    tiktok_link = models.URLField(verbose_name=_("Tik Tok Link"), help_text=_("Add the link to your Tik Tok page here (optional)."), blank=True, null=True, max_length=300)
    facebook_link = models.URLField(verbose_name=_("Facebook Link"), help_text=_("Add the link to your Facebook page here (optional)."), blank=True, null=True, max_length=300)
    website_link = models.URLField(verbose_name=_("Website Link"), help_text=_("Add the link to your website here (optional)."), blank=True, null=True, max_length=300)
    ###
    ...
    def get_profile_image_url(self):
        if self.profile_image: return self.profile_image.url
        else: return static("/images/default_profile_image.jpg")
